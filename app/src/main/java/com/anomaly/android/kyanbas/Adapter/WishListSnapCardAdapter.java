...
public class WishListSnapCardAdapter extends RecyclerView.Adapter<WishListSnapCardAdapter.ViewHolder> {

    private List<Art> mArts;
    private Context mContext;


    public WishListSnapCardAdapter(List<Art> apps, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.recycler_item_cardview, parent, false));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            cardView=itemView.findViewById(R.id.rc_item_cardview);
            imageView = (ImageView) itemView.findViewById(R.id.imageViewItemArtImage);
            nameTextView = (TextView) itemView.findViewById(R.id.textViewItemArtName);
            artUserTextView= (TextView) itemView.findViewById(R.id.textViewItemArtUserName);
            priceTextView= (TextView) itemView.findViewById(R.id.textViewItemArtPrice);
